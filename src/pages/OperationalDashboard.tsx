                      ...
                      {warehouseStatus.categories.map((category, index) => (
                        <div key={`category-${category.category}-${index}`} className="space-y-2">
                          ...
                          <div className="flex items-center text-xs text-gray-500 space-x-4">
                            ...
                            <span>Broken: {(category as any).broken}</span>
                            <span>Lost: {(category as any).lost}</span>
                          </div>
                                ...
                                <div className="flex min-w-0 flex-1 justify-between space-x-2">
                                  <div className="min-w-0 flex-1">
                                    ...
                                    <p className="text-xs text-gray-500 truncate">
                                      {(activity as any).activity_description || `${activity.transaction_type} → ${activity.to_status}`}
                                    </p>
                ...
                <div className="p-6">
                  {employeeAssignments.length > 0 ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      {employeeAssignments.slice(0, 8).map((assignment) => (
